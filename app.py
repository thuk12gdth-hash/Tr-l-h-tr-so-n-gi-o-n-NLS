...
<div class="main-header">
    ...
    <p>Tác giả: Nông Thị Thơm - Trường Tiểu học B Linh Hồ- ĐT: 0062433934</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nông Thị Thơm - Trường Tiểu học B Linh Hồ- ĐT: 0062433934</div>", unsafe_allow_html=True)
